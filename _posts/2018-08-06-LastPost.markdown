...
In these benchmarks, the two methods solve a generalized eigenvalue problem with sparse tridiagonal 1948 by 1948 matrix targeting eigenvalues that are smallest in magnitude.
...
BenchmarkTools.Trial:
  ...
  evals/sample:     1
```
Amount of matrix-vector products: 66 <br>
...
BenchmarkTools.Trial:
  ...
  evals/sample:     1
```
Amount of matrix-vector products: 473 <br>
...
BenchmarkTools.Trial:
  ...
  evals/sample:     1
```
Amount of matrix-vector products: 231 <br>
...
BenchmarkTools.Trial:
  ...
  evals/sample:     1
```
Amount of matrix-vector products: 22 <br>
...
# And lastly, what's the benefit of all of this?
